#include "REALCCPREFSRootListController.h"

@implementation REALCCPREFSRootListController
...
Her method involves overriding setPreferenceValue:specifier and readPreferenceValue: in the preference bundle to restore the old, pre-iOS 8 behaviour as it 
completely bypasses CFPreferences and writes directly to file.
